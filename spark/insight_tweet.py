...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        '/Users/bezerraescossia/Github/studies/'
        'twitter-project/datalake/silver/tweet'
    )
    ...
    tweet.coalesce(1)\
        .write\
        .json('/Users/bezerraescossia/Github/studies/twitter-project/datalake/gold/twitter_insight_tweet')